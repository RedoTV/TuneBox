            ...
            <ul className="flex flex-wrap gap-8 justify-center">
                {filteredPlaylists.map((playlist, index) => (
                    <li
                        ...
                        className="bg-white border border-gray-300 rounded-lg p-8 shadow-lg transition-transform transform hover:scale-105 cursor-pointer relative w-64 h-80 flex flex-col justify-between"
